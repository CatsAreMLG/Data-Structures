...
1. What is the runtime complexity of `insert`? O(1)
...
1. What is the runtime complexity of `_bubble_up`? O(n)

2. What is the runtime complexity of `_sift_down`? O(n)

3. What is the runtime complexity of `insert`? O(1)
